...
> Settings area: `project-markdown-mirror`
> Dashboard documentation route: `/docs/settings-project-markdown-mirror`

## What This Area Is For

Controls whether dashboard-authored agent presets are mirrored into project-local markdown files. This page expands the short Settings-page help text into an operator reference for deciding when to change this area, what behavior the controls affect, and what to verify after saving.
