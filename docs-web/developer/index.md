...
| # | Page | Purpose |
| --- | --- | --- |
| 1 | [MCP tools](./mcp-tools.md) | The per-domain `manage_*` tools and `search_knowledge`, with schemas |
| 2 | [Management actions](./management-actions.md) | Every action in every management domain |
