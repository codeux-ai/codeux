...
> **MCP HTTP gateway** (`--mcp-http`) is a *separate* listener for JSON-RPC and is documented in [MCP server](/docs/architecture-mcp-server).
...
| Path | Protocol |
| --- | --- |
| `/api/realtime` | WebSocket — see [Realtime protocol](/docs/developer-websocket-realtime). |
