...
| `/custom-dashboards` | [Custom Dashboards](/docs/user-dashboard-custom-dashboards) | Agent-generated project dashboards with detached validation and gated publication |
