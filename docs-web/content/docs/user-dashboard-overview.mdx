...
- **Top bar** — Project selector, theme toggle, mobile menu, notifications, and a compact scheduled-agent count when the selected project has active agent-created wakeups or task runs.
