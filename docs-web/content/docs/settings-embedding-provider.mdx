...
> Settings area: `embedding-provider`
> Dashboard documentation route: `/docs/settings-embedding-provider`

## What This Area Is For

Chooses in-app embeddings or an external OpenAI-compatible embeddings API. This page expands the short Settings-page help text into an operator reference for deciding when to change this area, what behavior the controls affect, and what to verify after saving.
