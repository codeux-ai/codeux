...
Dragging previews positions locally and commits once on pointer release. The Nodes route uses a static background while the canvas is mounted to avoid WebGL compositor pressure.
