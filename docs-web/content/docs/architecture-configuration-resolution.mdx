...
The user-facing reference for individual options is [Configuration & CLI](/docs/developer-configuration). The schema reference for settings is [Settings reference](/docs/developer-settings-reference). This page describes the *order of operations*.
