...
See [User Guide → Connecting MCP clients](/docs/user-mcp-clients#secure-headless-server-mode) for startup commands, client verification, settings synchronization, token rotation, and cluster troubleshooting.
