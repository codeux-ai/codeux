...
These contracts apply across [Node Flows](/docs/user-dashboard-node-flows), [Scheduler](/docs/user-dashboard-scheduler), [Custom Dashboards](/docs/user-dashboard-custom-dashboards), [Agents](/docs/user-dashboard-agents), [Projects](/docs/user-dashboard-projects), [Knowledge](/docs/user-dashboard-knowledge), [Browser Preview](/docs/user-dashboard-browser-preview), and [Chat](/docs/user-dashboard-chat). Each route page owns its detailed workflow.
...
For the contributor checklist, see [Dashboard Accessibility Quality Audit](/docs/user-dashboard-accessibility-quality-audit).
