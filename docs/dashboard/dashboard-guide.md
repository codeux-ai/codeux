...
- The header is a compact flat command surface for the page. It shows the page title, selected project, generated snapshot time, sprint lens, active mode guidance, and time-window controls with typographic context rows and a single responsive command band before the mode-specific metric deck.
