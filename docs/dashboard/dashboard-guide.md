...
- Organic sprint bubble cell shadows now use shape-following drop shadows on the animated shell, so the ambient background shadow tracks the biomorphic cell corners instead of the rectangular outer bounds.
