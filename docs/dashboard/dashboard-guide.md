...
- Quicksprint browse mode now uses horizontally scrollable rails with explicit left/right controls and a stable three-row desktop layout so large template catalogs stay reachable without vertical cut-off on mobile.
