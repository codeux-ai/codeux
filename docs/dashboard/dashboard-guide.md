...
- Organic sprint bubble hover shadows are applied to the animated shadow underlay rather than the square outer wrapper, so the shadow follows the biomorphic border-radius and rounded corners throughout the gallery animation.
