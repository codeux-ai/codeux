...
- System mode uses a compact debugging workbench organized around sprint state, invocation health, failure analysis, external API activity, and invocation records.
