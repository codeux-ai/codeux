...
4.  **Metadata and Hierarchy**:
    ...
    *   Subcategory help metadata lives in `dashboard/src/v2/lib/settings-subcategory-docs.ts`; canonical long-form pages live under `docs/settings/subcategories/`, and the published mirror lives in `docs-web/user/dashboard/settings.md`. Add or update all three surfaces when creating, renaming, or removing a settings subcategory.
