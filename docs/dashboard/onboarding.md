...
The Easy path contains four steps:
1. Setup mode
...
3. Provider
   ...
   - Marks Gemini CLI Deprecated, excludes it from fresh recommendations, and offers Antigravity as the replacement while preserving existing Gemini defaults.
