...
- Node points, edge pulse points, selection rings, and labels are drawn in inverse-zoom screen space so graph positions zoom while markers stay usable and text remains readable instead of growing with the map.
