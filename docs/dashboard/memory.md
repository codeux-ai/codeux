...
- Sidebar memory cards use a dense Warm Void row layout: category and scope metadata lead the card, selected memories get a compact Signal Jade rail and badge, and the action strip keeps selection, open-details, and lobotomize delete controls stable at narrow widths.
