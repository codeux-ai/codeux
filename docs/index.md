...
42. [Qwen Code Integration](./settings/qwen-code-integration.md)
43. [OpenCode Integration](./settings/opencode-integration.md)
44. [Dashboard Resource Layer](./architecture/dashboard-resource-layer.md)
45. [Dashboard Onboarding](./dashboard/onboarding.md)
46. [Browser Preview](./dashboard/browser-preview.md)
47. [Mobile Responsiveness](./dashboard/mobile-responsiveness.md)
48. [Electron Desktop App](./deployment/electron-desktop.md)
