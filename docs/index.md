...
46. [Qwen Code Integration](./settings/qwen-code-integration.md)
47. [OpenCode Integration](./settings/opencode-integration.md)
48. [Dashboard Resource Layer](./architecture/dashboard-resource-layer.md)
49. [Dashboard Onboarding](./dashboard/onboarding.md)
50. [Browser Preview](./dashboard/browser-preview.md)
51. [Mobile Responsiveness](./dashboard/mobile-responsiveness.md)
52. [Electron Desktop App](./deployment/electron-desktop.md)
