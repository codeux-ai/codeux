...
7. [Project Management Implementation](./architecture/project-management-implementation.md)
8. [Project Runtime Integration](./architecture/project-runtime-integration.md)
9. [MCP Connections And Listen Mode](./architecture/mcp-connections-and-listen-mode.md)
10. [MCP Worker Dispatch Executor](./architecture/mcp-worker-dispatch-executor.md)
11. [Atomic Sprint Loop](./sprint-loop/atomic-loop.md)
12. [Instruction Template System](./instructions/markdown-template-system.md)
13. [Configuration and Storage](./settings/configuration-and-storage.md)
