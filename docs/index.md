...
8. [Project Management Implementation](./architecture/project-management-implementation.md)
9. [Project Runtime Integration](./architecture/project-runtime-integration.md)
10. [MCP Connections And Listen Mode](./architecture/mcp-connections-and-listen-mode.md)
11. [MCP Worker Dispatch Executor](./architecture/mcp-worker-dispatch-executor.md)
12. [Atomic Sprint Loop](./sprint-loop/atomic-loop.md)
13. [Instruction Template System](./instructions/markdown-template-system.md)
14. [Configuration and Storage](./settings/configuration-and-storage.md)
