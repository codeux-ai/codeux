...
43. [Settings Subcategory Reference](./settings/subcategories/index.md)
44. [Qwen Code Integration](./settings/qwen-code-integration.md)
45. [OpenCode Integration](./settings/opencode-integration.md)
46. [Dashboard Resource Layer](./architecture/dashboard-resource-layer.md)
47. [Dashboard Onboarding](./dashboard/onboarding.md)
48. [Browser Preview](./dashboard/browser-preview.md)
49. [Mobile Responsiveness](./dashboard/mobile-responsiveness.md)
50. [Electron Desktop App](./deployment/electron-desktop.md)
