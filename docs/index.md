...
6. [Project Management Implementation](./architecture/project-management-implementation.md)
7. [Project Runtime Integration](./architecture/project-runtime-integration.md)
8. [MCP Connections And Listen Mode](./architecture/mcp-connections-and-listen-mode.md)
9. [Atomic Sprint Loop](./sprint-loop/atomic-loop.md)
10. [Instruction Template System](./instructions/markdown-template-system.md)
