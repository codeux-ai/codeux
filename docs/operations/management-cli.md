...
The full command reference lives in [CLI Commands Reference](../reference/cli-commands.md). That page covers the action aliases, required flags, interactive prompting behavior, `--json`, `--payload-json`, and approval handling.
