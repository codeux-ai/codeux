...
Open this subcategory from the dashboard docs route at `/docs/user-dashboard-settings#workspace-hygiene`. The Settings card header links to the matching published docs anchor.
