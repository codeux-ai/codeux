...
export const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    runtimeRoles: ["project_manager"],
    category: "orchestration",
    description: "Manage Code UX scheduler entries. Used to list, create, schedule_sprint, schedule_quicksprint, schedule_chat, schedule_node_flow, update, delete, and run_due. Entries can use an absolute scheduledFor time or an after_sprint_end anchor. Scheduled chat entries post messages through the chat runtime when due. Scheduled node flows run through the node flow runtime when due. Deleting entries requires approval.",
    inputSchema: {
      type: "object",
      properties: {
        ...
        scheduledFor: { type: "string", description: "Required ISO date for absolute create/schedule actions. Optional for update or after_sprint_end anchored entries." },
