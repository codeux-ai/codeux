...
export const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    runtimeRoles: ["project_manager"],
    category: "orchestration",
    description: "Manage Code UX scheduler entries. Used to list, create, schedule_sprint, schedule_quicksprint, schedule_chat, update, delete, and run_due. Entries can use an absolute scheduledFor time or an after_sprint_end anchor. Scheduled chat entries post messages through the chat runtime when due. Deleting entries requires approval.",
    inputSchema: {
      type: "object",
      properties: {
