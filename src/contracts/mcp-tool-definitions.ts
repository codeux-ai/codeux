  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        repository: { type: "string", description: "Optional owner/repo or GitLab project path for import_issues." },
        hostDomain: { type: "string", description: "Optional Git host domain for import_issues." },
        projectKey: { type: "string", description: "Optional Jira project key for import_issues." },
        assignee: { type: "string", description: "Optional assignee filter for import_issues." },
        assigneeText: { type: "string", description: "Optional Jira assignee text filter for import_issues. Supports me/currentUser()." },
        ...
        issueRefs: { type: "array", items: { type: "string" }, description: "Optional explicit issue references like JIRA-123, #42, or !42 for import_issues." },
