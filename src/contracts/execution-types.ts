...
export type ProviderInvocationPurpose = "task_coding" | "ci_fix" | "merge_conflict" | "planning" | "worker_reply" | "qa_review" | "clarification_reply" | "dashboard_reply" | "chat_compaction" | "remediation";
...
export interface ClaimedTaskDispatchRecord extends TaskDispatchRecord {
  leaseToken: string;
}
