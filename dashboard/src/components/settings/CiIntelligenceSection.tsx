...
const ciDescriptors: FieldDescriptor<DashboardSettings>[] = [
  ...
  {
    id: "waitForCiBeforeMainMerge",
    type: "toggle",
    label: "Wait for CI before merge into main",
    disabled: (settings) => !settings.ciIntelligence.enabled,
    getValue: (settings) => settings.ciIntelligence.waitForCiBeforeMainMerge,
    onToggle: (settings, checked) => updateCiIntelligence(settings, { waitForCiBeforeMainMerge: checked }),
  },
  {
  ...
  {
    id: "waitForCiBeforeFeatureMerge",
    type: "toggle",
    label: "Wait for CI before merge into feature branch",
    disabled: (settings) => !settings.ciIntelligence.enabled,
    getValue: (settings) => settings.ciIntelligence.waitForCiBeforeFeatureMerge,
    onToggle: (settings, checked) => updateCiIntelligence(settings, { waitForCiBeforeFeatureMerge: checked }),
  },
  {
  ...
  },
  {
    ...
    description: "Escalate detected main-branch merge conflicts to the connected worker with branch and sprint context.",
    disabled: (settings) => !settings.ciIntelligence.enabled || settings.git.githubMode === "LOCAL",
  ...
  },
  {
    ...
    disabled: (settings) => !settings.ciIntelligence.enabled || !settings.ciIntelligence.waitForCiBeforeFeatureMerge,
