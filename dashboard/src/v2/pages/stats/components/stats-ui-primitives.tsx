...
export const LEDGER_ROW_CLASS = "stats-ledger-row group rounded-[var(--stats-subpanel-radius)] p-4 transition-[background-color,border-color] duration-150 motion-reduce:transition-none";
export const LEDGER_ROW_MODERN_CLASS = "stats-ledger-row group relative overflow-hidden rounded-[var(--stats-subpanel-radius)] p-4 transition-[background-color,border-color] duration-150 motion-reduce:transition-none";
