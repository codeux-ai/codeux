  ...
  return (
    <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
      <div className="max-w-3xl min-w-0">
        ...
        <div className="mt-4 text-[clamp(2rem,4vw,3.1rem)] font-black tracking-tight text-[var(--stats-value-color)]">
          {title}
        </div>
        <div className="mt-3 max-w-2xl text-sm leading-relaxed text-[var(--stats-detail-color)]">
          {description}
        </div>
      </div>
      <div className="max-w-xl rounded-[1.4rem] border border-[var(--stats-card-border)] bg-[var(--stats-card-bg)] px-4 py-3 text-[11px] font-medium leading-relaxed text-[var(--stats-detail-color)] shadow-sm">
