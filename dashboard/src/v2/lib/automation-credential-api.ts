import type { AutomationCredentialBinding, AutomationCredentialMetadata, CreateAutomationCredentialInput, CredentialBackendHealth } from "../../../../src/contracts/automation-credential-types.js";
...
export const bindAutomationCredential = (projectId:string,id:string,input:{bindingKey:string;capabilities:string[]}):Promise<AutomationCredentialBinding> => fetchJson(`${base(projectId)}/${encodeURIComponent(id)}/bind`,json("POST",input));
...
export const restrictAutomationCredential = (projectId:string,id:string,input:{allowedProjectIds:string[];capabilities:string[]}):Promise<AutomationCredentialMetadata> => fetchJson(`${base(projectId)}/${encodeURIComponent(id)}/restrict`,json("POST",input));
