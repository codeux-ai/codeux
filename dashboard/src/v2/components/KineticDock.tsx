    ...
    const renderItem = (item: typeof ALL_ITEMS[number], globalIndex: number) => {
        ...
        return (
            <Link
                ...
                className="relative group flex flex-col items-center justify-center w-[52px] h-[52px] rounded-[1.4rem] transition-colors duration-300 decoration-none focus-visible:ring-2 focus-visible:ring-signal-500/50"
            >
