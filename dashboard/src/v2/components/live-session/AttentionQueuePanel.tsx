...
export const AttentionQueuePanel: FunctionComponent = memo(() => {
            ...
            <div role="status" className="rounded-[1.75rem] border border-black/[0.08] bg-white p-5 shadow-sm dark:border-white/[0.08] dark:bg-void-800">
                <div className="flex items-start gap-3 rounded-r-xl rounded-l-sm border border-l-2 border-black/[0.04] border-l-status-green bg-black/[0.015] p-3 dark:border-white/[0.04] dark:bg-white/[0.015]">
                    ...
                    <div>
                        ...
                        <p className="mt-1 break-words text-[11px] font-mono leading-relaxed text-slate-400 dark:text-slate-500">All tasks and workers are proceeding normally.</p>
                    </div>
                </div>
            </div>
        );
    ...
    return (
        <div className="flex flex-col gap-3">
            ...
            {open > 0 && (
                <div className="flex items-center gap-2 rounded-r-xl rounded-l-sm border border-l-2 border-status-amber/20 border-l-status-amber bg-black/[0.015] px-3 py-2 text-[10px] font-bold uppercase tracking-[0.14em] text-status-amber dark:bg-white/[0.015]">
