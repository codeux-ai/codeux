        ...
        >
            ...
            <nav aria-label="User Menu" className="flex items-center gap-3">
                        ...
                        <div role="listbox" aria-label="Project list" className="absolute right-0 top-full mt-2 w-56 bg-white/95 dark:bg-void-800/95 backdrop-blur-2xl border border-black/[0.06] dark:border-white/[0.08] rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.12)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.4)] overflow-hidden z-50">
                            ...
                            <div className="p-2 border-t border-black/[0.04] dark:border-white/[0.04] mt-1 flex flex-col gap-1">
                                <button
                                    ...
                                    className="w-full flex items-center gap-2 px-3 py-2 text-xs font-semibold text-ember-600 dark:text-ember-400 hover:bg-ember-500/[0.06] rounded-xl transition-colors"
                                >
                ...
                {selectedProject && (
                    <div className="relative hidden md:block" ref={sprintDropdownRef} onKeyDown={sprintKb.onContainerKeyDown}>
                        <button
                            ...
                            className={`flex items-center gap-2.5 px-3.5 py-2 bg-black/[0.04] dark:bg-white/[0.04] border border-transparent rounded-xl transition-all group ${ sprints.length > 0 ? 'hover:border-black/[0.08] dark:hover:border-white/[0.08] cursor-pointer' : 'opacity-50 cursor-not-allowed' }`}
                        >
                            <span className="text-sm font-semibold text-slate-700 dark:text-slate-200 font-mono">
                                ...
                                <div className="max-h-64 overflow-y-auto">
                                    {workerOptions.map((option) => (
                                        <button
                                            ...
                                            className={`w-full flex items-center gap-3 px-3 py-3 text-left transition-colors group ${ option.isPrimary ? 'bg-signal-500/8' : '' } ${ option.isSelectable && !workerSwitchBusy ? 'hover:bg-signal-500/5' : 'cursor-not-allowed opacity-55' }`}
                                        >
                ...
                <button
                    ...
                    className="relative w-11 h-11 flex items-center justify-center rounded-xl hover:bg-black/[0.05] dark:hover:bg-white/[0.05] transition-colors group"
                >
                ...
                <button
                    ...
                    className="w-11 h-11 flex items-center justify-center rounded-xl hover:bg-black/[0.05] dark:hover:bg-white/[0.05] transition-colors"
                >
                    {isDark
