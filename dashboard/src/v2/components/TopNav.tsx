            ...
            <div className="flex items-center gap-10 flex-1">
                ...
                <div className="relative group w-full max-w-xs">
                    ...
                    <input
                        ...
                        className="w-full h-9 pl-10 pr-12 bg-black/[0.04] dark:bg-white/[0.04] border border-transparent hover:border-black/[0.08] dark:hover:border-white/[0.08] focus-visible:border-signal-500/40 dark:focus-visible:border-signal-500/40 rounded-xl text-sm text-slate-900 dark:text-white placeholder-slate-400 focus-visible:ring-2 focus-visible:ring-signal-500/10 transition-all"
                    />
