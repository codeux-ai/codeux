...
export const Sidebar: FunctionComponent = () => {
    ...
    return (
        ...
        >
            ...
            {/* Logo */}
            <a href="/" className="px-4 sm:px-7 mb-8 sm:mb-10 flex items-center gap-2 sm:gap-3 group cursor-pointer relative z-10 w-fit">
                ...
                {navItems.map((item, idx) => {
                    ...
                    return (
                        <button
                            ...
                            className="relative flex items-center gap-4 sm:gap-3.5 px-5 py-3 rounded-2xl transition-colors duration-200 w-full text-left group overflow-hidden mb-0.5 focus-visible:ring-2 focus-visible:ring-signal-500/40 focus-visible:rounded-2xl focus-visible:z-10"
                        >
                            <div className={`absolute inset-0 rounded-2xl transition-opacity duration-300 pointer-events-none ${isActive ? 'bg-signal-500/8 dark:bg-signal-500/10 opacity-100' : 'bg-transparent opacity-0 group-hover:bg-black/[0.03] dark:group-hover:bg-white/[0.03] group-hover:opacity-100 group-active:opacity-100 group-focus-within:opacity-100'}`} />
            ...
            <div className="px-4 relative z-10">
                <button aria-label="Settings" className="relative w-full flex items-center gap-3.5 px-5 py-3 rounded-2xl transition-colors duration-200 text-left group overflow-hidden focus-visible:ring-2 focus-visible:ring-signal-500/40 focus-visible:rounded-2xl focus-visible:z-10">
                    <div className="absolute inset-0 rounded-2xl bg-transparent group-hover:bg-black/[0.03] dark:group-hover:bg-white/[0.03] transition-opacity duration-300 pointer-events-none opacity-0 group-hover:opacity-100 group-active:opacity-100 group-focus-within:opacity-100" />
