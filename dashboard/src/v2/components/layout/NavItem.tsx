...
export const NavItem: FunctionComponent<NavItemProps> = ({ item, isActive, isMinimized, isMobile, onClose, elementRef }) => {
    return (
        ...
        >
            ...
            <div className={`absolute inset-0 rounded-2xl transition-all motion-reduce:transition-none duration-300 pointer-events-none origin-left bg-black/[0.05] dark:bg-white/[0.05] opacity-0 group-hover:opacity-100 group-focus-visible:opacity-100`} />
