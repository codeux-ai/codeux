      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-start justify-between gap-3 border-b border-black/[0.06] pb-3 dark:border-white/[0.08]">
          <div className="min-w-0">
            <div className="font-mono text-[10px] font-bold uppercase tracking-[0.16em] text-signal-600 dark:text-signal-300">{node.task.id}</div>
            <div className="mt-1 line-clamp-2 text-sm font-semibold leading-snug text-slate-900 dark:text-white">{node.task.title}</div>
          </div>
        ...
        <div className="grid grid-cols-3 gap-2">
          {[
            ...
            <div key={label} className="rounded-[0.9rem] border border-black/[0.06] bg-white/75 px-3 py-2 dark:border-white/[0.07] dark:bg-white/[0.04]">
              ...
              <div className="mt-1 font-mono text-sm font-semibold text-slate-800 dark:text-white">{value}</div>
            </div>
          ))}
        </div>
      </div>
          ...
          <div className="relative z-10 flex min-h-0 flex-1 flex-col">
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-2 line-clamp-2 text-[13px] font-semibold leading-snug tracking-tight text-slate-900 dark:text-white">
                  {node.task.title}
                </div>
              </div>
