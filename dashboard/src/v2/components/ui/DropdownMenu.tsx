      ...
      {isRendered && typeof document !== "undefined" &&
        createPortal(
          <div
            ...
            className={`fixed z-[100] max-w-[calc(100vw-2rem)] overflow-hidden rounded-2xl border border-black/[0.08] bg-white p-2 shadow-[0_16px_36px_rgba(15,23,42,0.14)] outline-none dark:border-white/[0.08] dark:bg-void-800 dark:shadow-[0_16px_36px_rgba(0,0,0,0.4)] ${!isOpen ? "pointer-events-none" : ""} ${className}`}
