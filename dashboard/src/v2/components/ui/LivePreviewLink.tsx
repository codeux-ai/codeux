...
export const LivePreviewLink: FunctionComponent<LivePreviewLinkProps> = ({ session }) => {
    ...
    return (
        <a
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-[10px] text-xs font-bold text-white bg-signal-500 hover:bg-signal-600 shadow-sm transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-signal-500/50 focus-visible:outline-none"
        >
