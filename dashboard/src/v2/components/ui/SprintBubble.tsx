      ...
      <div className="relative z-20 flex h-full w-full flex-col items-center justify-center p-8 text-center">
        ...
        <div className="absolute bottom-5 flex w-full translate-y-2 items-center justify-center gap-3 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
          <button
            ...
            className={`touch-target flex h-11 w-11 items-center justify-center rounded-full text-slate-800 transition-all duration-300 dark:text-white ${
              isRunning
          ...
          <a
            ...
            className="touch-target inline-flex h-11 items-center gap-1.5 rounded-full bg-slate-900 px-5 text-[10px] font-bold uppercase tracking-[0.1em] text-white shadow-[0_4px_12px_rgba(0,0,0,0.15)] transition-all hover:opacity-85 dark:bg-white dark:text-void-900"
          >
            View Tasks
          ...
          <button
            ...
            className="touch-target flex h-11 w-11 items-center justify-center rounded-full bg-black/[0.06] text-slate-800 transition-colors hover:bg-black/10 dark:bg-white/[0.07] dark:text-white dark:hover:bg-white/10"
            title="Settings"
          >
