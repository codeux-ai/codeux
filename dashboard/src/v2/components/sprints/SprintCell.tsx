...
export const SprintCell: FunctionComponent<SprintCellProps> = ({
  ...
  return (
    ...
    >
      <div
        className={`pointer-events-none absolute inset-0 rounded-[1.75rem] shadow-[0_24px_48px_rgba(15,23,42,0.07)] transition-shadow duration-300 [@media(hover:hover)]:group-hover:shadow-[0_34px_72px_rgba(15,23,42,0.18)] group-focus-within:shadow-[0_34px_72px_rgba(15,23,42,0.18)] dark:shadow-[0_24px_48px_rgba(0,0,0,0.5)] dark:[@media(hover:hover)]:group-hover:shadow-[0_34px_72px_rgba(0,0,0,0.62)] dark:group-focus-within:shadow-[0_34px_72px_rgba(0,0,0,0.62)] ${animationClass} ${isCompleted ? "opacity-80" : ""}`}
