...
export const SprintLedgerBulkActions: FunctionComponent<SprintLedgerBulkActionsProps> = ({
  ...
  return (
    <div
      ...
      style={{ height: 0 }}
    >
      <div className="flex flex-col gap-3 border-b border-signal-500/20 bg-[linear-gradient(90deg,rgba(0,224,160,0.10),rgba(255,184,0,0.05))] px-4 py-3 backdrop-blur-xl sm:px-6 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex min-w-0 items-center gap-3">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-2xl border border-signal-500/20 bg-[var(--surface-glass)] text-signal-700 shadow-[var(--elevation-base)] dark:text-signal-300">
          ...
          <div className="min-w-0" aria-live="polite" aria-atomic="true">
            ...
            <div className="text-xs text-[color:var(--text-metadata)]">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className="inline-flex h-9 min-w-0 flex-1 items-center justify-center gap-1.5 whitespace-nowrap rounded-xl border border-[color:var(--border-hairline)] bg-[var(--surface-glass)] px-3 text-xs font-bold text-slate-600 shadow-[var(--elevation-base)] transition-colors hover:bg-[var(--surface-glass-hover)] hover:text-slate-900 focus-visible:ring-2 focus-visible:ring-signal-500/30 focus-visible:ring-offset-2 dark:text-slate-300 dark:hover:text-white disabled:cursor-not-allowed disabled:opacity-50 sm:flex-none"
          >
          ...
          <button
            ...
            onClick={onBulkStart}
            disabled={isAnyPending}
            className="inline-flex h-9 min-w-0 flex-1 items-center justify-center gap-1.5 whitespace-nowrap rounded-xl border border-signal-500/25 bg-signal-500/10 px-3 text-xs font-bold text-signal-700 transition-colors hover:bg-signal-500/20 focus-visible:ring-2 focus-visible:ring-signal-500/30 focus-visible:ring-offset-2 dark:text-signal-300 disabled:cursor-not-allowed disabled:opacity-50 sm:flex-none"
          >
          ...
          <button
            ...
            disabled={isAnyPending}
            className="inline-flex h-9 min-w-0 flex-1 items-center justify-center gap-1.5 whitespace-nowrap rounded-xl border border-status-red/20 bg-status-red/10 px-3 text-xs font-bold text-status-red transition-colors hover:bg-status-red/20 focus-visible:ring-2 focus-visible:ring-status-red/30 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 sm:flex-none"
          >
          ...
          <button
            ...
            disabled={isAnyPending}
            className="inline-flex h-9 min-w-0 flex-1 items-center justify-center gap-1.5 whitespace-nowrap rounded-xl px-3 text-xs font-bold text-[color:var(--text-metadata)] transition-colors hover:bg-[color:var(--fill-muted-hover)] hover:text-slate-700 focus-visible:ring-2 focus-visible:ring-signal-500/30 focus-visible:ring-offset-2 dark:hover:text-slate-200 disabled:cursor-not-allowed disabled:opacity-50 sm:flex-none"
          >
