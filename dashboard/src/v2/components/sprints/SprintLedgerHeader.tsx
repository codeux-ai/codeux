...
export const SprintLedgerHeader: FunctionComponent<SprintLedgerHeaderProps> = ({
  ...
  return (
    <div className="flex flex-col xl:flex-row flex-wrap items-start xl:items-center justify-between gap-4 border-b border-black/[0.06] px-6 py-5 dark:border-white/[0.06]">
      ...
      <div className="flex flex-wrap items-center gap-3 w-full xl:w-auto">
        ...
        />
        {/* Search */}
        <div className="relative flex-1 xl:flex-none min-w-[12rem]">
          ...
          <input
            ...
            className="h-9 w-full xl:w-56 rounded-full border border-black/[0.08] bg-white/80 pl-9 pr-8 text-xs text-slate-700 placeholder:text-slate-400 focus:border-signal-500/40 focus:outline-none focus:ring-2 focus:ring-signal-500/10 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-white dark:placeholder:text-slate-500"
          />
          {searchQuery && (
            <button
              type="button"
