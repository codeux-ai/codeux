  ...
  const filtersContent = (
    <div className="grid gap-5">
          ...
          {(["github", "gitlab"] as const).map((provider) => {
            ...
            return (
              <button
                ...
                className={`inline-flex min-h-11 items-center justify-center gap-2 rounded-[1rem] border px-3 py-2 text-[10px] font-bold uppercase tracking-[0.14em] transition-all focus-visible:outline-none focus-visible:ring-2 ${metadata.accent.focusRingClassName} ${
                  active
      ...
      <section className="grid gap-3">
        ...
        <div className="grid min-w-0 gap-3 md:grid-cols-[minmax(11rem,0.7fr)_minmax(14rem,1fr)]">
          <label className="grid min-w-0 gap-1.5">
            ...
            <input
              ...
              className={`h-11 min-w-0 rounded-[1rem] border border-black/[0.07] bg-black/[0.025] px-3 text-sm text-slate-700 outline-none transition-colors focus:border-signal-500 dark:border-white/[0.08] dark:bg-white/[0.035] dark:text-slate-200 ${providerMetadata.accent.focusRingClassName}`}
        ...
        <label className="grid min-w-0 gap-1.5">
          ...
          <div className="relative min-w-0">
            ...
            <input
              ...
              className="h-11 w-full min-w-0 rounded-[1rem] border border-black/[0.07] bg-black/[0.025] pl-10 pr-3 text-sm text-slate-700 outline-none transition-colors focus:border-signal-500 dark:border-white/[0.08] dark:bg-white/[0.035] dark:text-slate-200"
            />
          </div>
        </label>
        <div className="grid min-w-0 gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <label className="grid min-w-0 gap-1.5">
            ...
            <select
              ...
              className="h-11 min-w-0 rounded-[1rem] border border-black/[0.07] bg-black/[0.025] px-3 text-xs font-bold uppercase tracking-[0.12em] text-slate-500 outline-none focus:border-signal-500 dark:border-white/[0.08] dark:bg-white/[0.035] dark:text-slate-300"
            >
        ...
        <div className="grid min-w-0 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          <label className="grid min-w-0 gap-1.5">
            ...
            <input
              ...
              className="h-11 min-w-0 rounded-[1rem] border border-black/[0.07] bg-black/[0.025] px-3 text-sm text-slate-700 outline-none transition-colors focus:border-signal-500 dark:border-white/[0.08] dark:bg-white/[0.035] dark:text-slate-200"
            />
          </label>
          <label className="grid min-w-0 gap-1.5">
