    ...
    <div className="relative z-10 -mt-10 flex flex-col gap-6 p-8">
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          type="button"
          onClick={onEdit}
          className="touch-target inline-flex items-center gap-2 rounded-full bg-signal-500 px-5 py-2.5 text-sm font-bold text-slate-900 shadow-lg shadow-signal-500/20 transition-all hover:scale-105 hover:bg-signal-400 focus:outline-none focus:ring-4 focus:ring-signal-500/30"
        >
