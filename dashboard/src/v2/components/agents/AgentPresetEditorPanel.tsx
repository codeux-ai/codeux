      ...
      <div className="flex items-center justify-between border-b border-black/5 pb-4 dark:border-white/5">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            onClick={onCancel}
            disabled={saving}
            className="touch-target inline-flex items-center gap-2 rounded-full border border-black/10 bg-transparent px-4 py-2 text-sm font-bold text-slate-600 transition-colors hover:bg-black/5 disabled:opacity-50 dark:border-white/10 dark:text-slate-300 dark:hover:bg-white/5"
          >
