...
export const StatsMetricCard: FunctionComponent<StatsMetricCardProps> = ({
  ...
  return (
    <StatsCard
      ...
      density="compact"
      tone="warm"
      className="min-h-[11.5rem] min-w-0 max-w-full"
    >
      <div ref={contentRef} className="relative z-10">
        <div className="relative mt-3 h-14 min-h-14 min-w-0 overflow-hidden rounded-[var(--stats-control-radius)]">
          {hasSparkline ? (
            <Sparkline
              points={sparkline}
              color={accentHex}
        ...
        <div className="mt-3 grid min-h-[2.25rem] min-w-0 content-end gap-2 border-t border-[color:var(--stats-card-border)] pt-2.5 [overflow-wrap:anywhere]">
