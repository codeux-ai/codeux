# Sprint 2 Extension: Test Coverage Hardening

- Primary objective: Close the coverage gaps identified in the Sprint 2 CI failure to reach the 80% line coverage threshold.

## Backlog: Coverage Tasks (T31-T40)

### T31 - Add Unit Tests for `src/index.ts`
...
### T32 - Improve Coverage for `src/app/dependency-factory/`
...
### T33 - Add Tests for Lifecycle Services
...
### T34 - Harden Coverage for `src/infrastructure/providers/cli/`
...
### T35 - Complete Coverage for `WorkspaceManager`
...
### T36 - Add Tests for `ActivityCacheService`
...
### T37 - Harden `JulesAgentServer` Coverage
...
### T38 - Close Gaps in `CliWorkflowService` and `GitStatusService`
...
### T39 - Improve `ActionRequiredAutomation` and `BranchPreflightStep` Coverage
...
### T40 - Final Coverage Stabilization and Threshold Enforcement
